...
/* ---------- Finale worlds ----------
   Every companion's campaign ends in its own world. No painted maps yet —
   these carry the identity (name/accent/trial) the progression logic and
   copy need; map art is a later, separate delivery. */
